...
- 更新：智源社区分享，[回放视频](https://hub.baai.ac.cn/view/6236)及 <a href="https://github.com/StarGolx/notes/blob/master/docs/ml/materials/20210202-interpretability-slides-yzhang.pdf" target="_blank" rel="noopener noreferrer" class="outbound">PPT</a>
...
得益于前面提到的分类维度，我们可以把现有的可解释性论文放到一个三维空间中（访问[在线版](https://StarGolx.github.io/tmp-data/index.html)）
